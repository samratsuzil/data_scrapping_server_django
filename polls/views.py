...
# flipkart
    ...
    for a in html_soup.find_all('div',  attrs={'class': '_3liAhj'}):
        ...
        result = {"imageLink": ("None" if(imageLink == None) else imageLink.get('src')), "Link": ("None" if(
            link == None) else 'https://www.flipkart.com'+link.get('href')), "Name": ("None" if(name == None) else name.get('title')), "Price": price.text, }
